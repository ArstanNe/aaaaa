...
echo "<script>alert('Адрес электронной почты или номер мобильного телефона недействительны.');</script>"; 
}
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Система Базы Данных Библиотека | Восстановление пароля </title>
...
<div class="col-md-12">
<h4 class="header-line">Восстановление пароля пользователя</h4>
</div>
</div>
...
<input class="form-control" type="password" name="confirmpassword" required autocomplete="off"  />
 ...
 <button type="submit" name="change" class="btn btn-info">Сменить</button> | <a href="index.php">Вход в систему</a>
</form>
 </div>
</div>
</div>
