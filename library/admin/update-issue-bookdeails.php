...
<head>
    ...
    <title>Система Базы Данных Библиотека | Детали возвращения книг</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Сведения возвращения книг</h4>
...
<h4>Сведения о студенте</h4>
<hr />
<div class="col-md-6"> 
<div class="form-group">
<label>Студ.билет :</label>
...
<div class="col-md-6"> 
<div class="form-group">
<label>Дата выдачи книги :</label>
<?php echo htmlentities($result->IssuesDate);?>
</div></div>

<div class="col-md-6"> 
<div class="form-group">
<label>Дата возвращения книги :</label>
<?php if($result->ReturnDate=="")
                                            {
                                                echo htmlentities("Не возвращена");
                                            } else {
...
<button type="submit" name="return" id="submit" class="btn btn-info">Вернуть книгу </button>
