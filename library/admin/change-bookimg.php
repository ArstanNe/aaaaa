...
$query->execute();
unlink($cpath);
echo "<script>alert('Изображение книги успешно обновлено!');</script>";
...
<head>
    ...
    <title>Система Базы Данных Библиотека | Редактировать книгу</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Редактировать книгу</h4>
...
<div class="col-md-6">  
 <div class="form-group">
 <label>Файл изображения<span style="color:red;">*</span></label>
