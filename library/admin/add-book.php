...
{
echo "<script>alert('Недопустимый формат. Разрешен только формат jpg / jpeg / png / gif');</script>";
}
else
{
...
if($lastInsertId)
{
echo "<script>alert('Книга успешно внесена в список!');</script>";
...
<head>
    ...
    <title>Система Базы Данных Библиотека | Добавить книгу</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Добавить книгу</h4>
...
<label>Название книги<span style="color:red;">*</span></label>
...
<div class="col-md-6">  
<div class="form-group">
<label> Автор<span style="color:red;">*</span></label>
...
<div class="col-md-6">  
<div class="form-group">
<label>Номер ISBN<span style="color:red;">*</span></label>
<input class="form-control" type="text" name="isbn" id="isbn" required="required" autocomplete="off" onBlur="checkisbnAvailability()"  />
<p class="help-block">ISBN - это Международный стандартный номер книги. ISBN должен быть уникальным.</p>
...
<div class="col-md-6">  
 <div class="form-group">
 <label>Изображение книги<span style="color:red;">*</span></label>
 <input class="form-control" type="file" name="bookpic" autocomplete="off"   required="required" />
 </div>
    </div>
<button type="submit" name="add" id="add" class="btn btn-info">Сохранить </button>
 </div>
</div>
                            </div>
