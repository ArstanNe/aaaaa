...
<head>
    ...
    <title>Система Базы Данных Библиотека | Студенческая история</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <?php $sid=$_GET['stdid']; ?>
                <h4 class="header-line">#<?php echo $sid;?> История выдачи книги</h4>
    </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Штраф (если таковой имеется)</th>
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php if($result->ReturnDate==''): echo "Не возвращена";
