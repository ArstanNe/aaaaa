...
$query -> execute();
$_SESSION['delmsg']="Книга успешно удалена!";
...
<head>
    ...
    <title>Система Базы Данных Библиотека | Управление книгами</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Управление книгами</h4>
    </div>
...
<img src="bookimg/<?php echo htmlentities($result->bookImage);?>" width="100">
                                          ...
                                          <a href="manage-books.php?del=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Вы уверены, что хотите удалить?');"" >  <button class="btn btn-danger"><i class="fa fa-pencil"></i> </button>
                                            </td>
                                        </tr>
 <?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
