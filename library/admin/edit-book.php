...
$query->execute();
echo "<script>alert('Информация о книге успешно обновлена!');</script>";
...
<head>
    ...
    <title>Система Базы Данных Библиотека | Редактирование книги</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Редактирование книги</h4>
...
<a href="change-bookimg.php?bookid=<?php echo htmlentities($result->bookid);?>">Сменить изображение книги</a>
</div></div>
...
<div class="col-md-6">
<div class="form-group">
<label>ISBN номер<span style="color:red;">*</span></label>
...
<button type="submit" name="update" class="btn btn-info">Обновить </button></div>
